...
void Map::render(ShaderProgram* program)
{
    ...
    glVertexAttribPointer(program->GetPositionAttribute(), 2, GL_FLOAT, false, 0, m_vertices.data());
    glEnableVertexAttribArray(program->GetPositionAttribute());
    glVertexAttribPointer(program->GetTexCoordAttribute(), 2, GL_FLOAT, false, 0, m_texture_coordinates.data());
